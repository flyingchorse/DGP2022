			...
			<?php endif; ?>
						...
						<?php if ( ! has_custom_logo() ) { ?>
							...
							<?php if ( is_front_page() ) : ?>
								...
								<h1 ><a class="navbar-brand" rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" itemprop="url"><?php bloginfo( 'name' ); ?><span class="brandnamestyle"> <?php bloginfo ( 'description' ); ?></span></a></h1>
				...
				<button class="navbar-toggler justify-content-end" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle navigation', 'understrap' ); ?>">
					...
					<?php wp_nav_menu(
						array(
							...
							'container_class' => 'collapse navbar-collapse justify-content-end navbar-dark',
